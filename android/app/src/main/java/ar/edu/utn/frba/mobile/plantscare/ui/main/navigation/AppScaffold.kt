...
@Composable
fun AppScaffold(navController: NavHostController, applicationViewModel: ApplicationViewModel) {
    AppTheme {
        Scaffold(
            topBar = { TopNavigation(navController) },
            bottomBar = { BottomNavigation(navController) },
        ){
            paddingValues -> BottomNavigationGraph(navController, paddingValues, applicationViewModel)
        }
    }
}
